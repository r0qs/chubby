...
class Caracter(pygame.sprite.Sprite):
    ...
    def __init__(self, name, img, frames=1, width=115, height=115, fps=25):
        ...
        print self.mask.get_at((2,5))
        print self.mask.get_at((57,57))
    ...
    def update(self, t, width, height, cam_speed):
        ...
        self.rect = (self.real_x, self.y, self._w, self._h)
    ...
    def collides_with_objects_b(self, objects_list):
        ac = 0
        while ac < len(objects_list):
            obj = objects_list[ac].rect

            if (self.real_x + self._w) >= obj[0] and self.real_x <= obj[0] + obj[2] \
            and self.y + self._h >= obj[1]:
            
                try:
                    if (self.y + self._h) > obj[1] + 1 and self.y < obj[1] + obj[3] \
                    and self.real_x + self._w > obj[0] and self.real_x < obj[0] + obj[2]:
